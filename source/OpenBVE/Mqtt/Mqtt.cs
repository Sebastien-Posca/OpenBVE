...
namespace OpenBve.Mqtt
{
	public static class Mqtt
	{
		...
		static Mqtt()
		{
			...
			client.Subscribe(new String[] { "/train/actuators/PowerUp", "/train/actuators/PowerDown" }, new byte[] { MqttMsgBase.QOS_LEVEL_AT_MOST_ONCE, MqttMsgBase.QOS_LEVEL_AT_MOST_ONCE });
